              ...
              <div className="timeline">
                <div className="timeline-item left">
                  <div className="timeline-img-wrapper">
                    <img src="../public/i1.jpg" alt="First Meeting" />
                  </div>
                ...
                <div className="timeline-item right">
                  <div className="timeline-img-wrapper">
                    <img src="../public/i2.jpg" alt="First Date" />
                  </div>
                  <div className="timeline-content">
                    <h4>First Date</h4>
                ...
                <div className="timeline-item left">
                  <div className="timeline-img-wrapper">
                    <img src="../public/i3.jpeg" alt="Shopping Together" />
                  </div>
                  <div className="timeline-content">
                ...
                <div className="timeline-item right">
                  <div className="timeline-img-wrapper">
                    <img src="../public/i4.jpg" alt="Pinterest Photos" />
                  </div>
                  <div className="timeline-content">
                ...
                <div className="timeline-item left">
                  <div className="timeline-img-wrapper">
                    <img src="../public/i5.jpeg" alt="I Love You" />
                  </div>
                  <div className="timeline-content">
                ...
                <div className="timeline-item right">
                  <div className="timeline-img-wrapper">
                    <img src="../public/i6.jpeg" alt="Goodbyes" />
                  </div>
                  <div className="timeline-content">
                    <h4>The Goodbyes</h4>
